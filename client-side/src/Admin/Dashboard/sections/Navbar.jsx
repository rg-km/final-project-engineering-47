...
import {
  Box, Center, Flex, Input, Spacer, MenuGroup, MenuDivider, Image, Heading, Text, Button, IconButton, Menu, MenuButton, MenuItem, MenuList, HStack, FormControl,
  FormLabel,
  FormErrorMessage,
  FormHelperText,
    ...
    <>
      <IconContext.Provider value={{ color: '#fff' }}>
        <div className='navbar'>
          ...
          <Image width='100px' mr='40px' src={Logo}></Image>
        </div>
